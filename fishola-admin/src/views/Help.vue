    ...
    <div id="help-content">
          ...
          <tr>
            ...
            <td>
              <b-icon
                ...
                size="is-medium"
              ></b-icon>
              (<b>Uniquement si l'administrateur dispose du droit de gestion des administrateurs</b>, et restreint aux
              lacs de l'administrateur)
            </td>
            <td><b-icon
                icon="check"
                size="is-medium"
      ...
      <p>
        ...
        <img
          ...
          src="/img/help/create-specie-form.png"
          alt="Formulaire de création d'une espèce"
        />
      </p>
