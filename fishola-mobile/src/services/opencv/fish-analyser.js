export default class FisholaOpenCVService {
  ...
  calculateSizes(cv, imgElement, minSizeRatio, leftSizeObjectSizeMm, fixedSize) {
        ...
        let src = this.resize(cv, imgElement, fixedSize);
       ...
       /* TODO
        ...
        let dst = this.resize(cv, imgElement, fixedSize);
        ...
        let html = html1 + '</tr>' + html2 + '</tr></table>';
    ...
    resize(cv, imgElement, fixedSize) {
